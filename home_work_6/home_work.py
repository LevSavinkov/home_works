...
def transformation_name(func, *args):
...
def open_browser(browser_name):
    actual_result = transformation_name(open_browser, browser_name)
    assert actual_result == "Open browser [Chrome]"


def go_to_companyname_homepage(page_url):
    actual_result = transformation_name(go_to_companyname_homepage, page_url)
    assert actual_result == "Go to companyname homepage [https://companyname.com]"


def find_registration_button_on_login_page(page_url, button_text):
    actual_result = transformation_name(find_registration_button_on_login_page, page_url, button_text)
